...
const ModalTicket = () => {
  ...
  return (
    <div className="absolute bg-gray-900/50 w-full min-h-screen" onClick={handleModalClick}>
        <div className="absolute inset-0 flex items-center justify-center" >

            <div ref={modalRef} className="bg-white shadow-lg w-4/5  md:w-/2 max-w-2xl p-3 rounded " >
                
                <div className="flex items-center justify-between mb-4">
                    <h1 className="font-bold text-lg md:text-2xl">Detalhes do chamado:</h1>   
                    <button onClick={handleModalVisible} className="bg-red-500 px-2 p-1 text-white rounded">
                        Fechar
                    </button>
                </div>
